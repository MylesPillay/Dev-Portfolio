...
const SoftSkillsSection = ({
  ...
  return (
    <button
      className={ `my-2 h-auto w-full justify-between overflow-hidden border-b border-t border-orangeflame p-4 text-left transition-all duration-300 ease-in-out ${isHovered
      ...
      onClick={() => handleClickSkillsContainer({ setSingularExpansion, setIsHovered, isHovered, section: 'soft' })}
    >
