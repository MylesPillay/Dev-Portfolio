	...
	return (
		<div className='bg-slate-800 bg-opacity-50 h-[100%] py-4 md:py-0 border-t border-b border-orangeflame w-full'>
			<div className='flex flex-row w-full space-x-2 justify-around  items-center lg:justify-start px-6 lg:px-4'>
				<div className='text-xl font-medium  text-orangeflame align-baseline h-full lg:mb-0 lg:mr-20'>
					Links:
				</div>
				<div className='flex lg:flex-1 flex-wrap justify-evenly   pr-20 py-6 lg:py-4 gap-4 lg:gap-8  snap-always align-baseline  '>
					<IconLink
