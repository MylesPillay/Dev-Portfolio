...
const WebsiteProjectImages: React.FC<WebsiteProjectImagesProps> = ({
	...
	return (
		<div className='flex w-full rounded-lg align-middle justify-center items-start self-center h-auto max-h-[40vh] min-h-[40vh] overflow-y-scroll overflow-x-hidden'>
